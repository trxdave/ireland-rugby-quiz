...
Homepage - ![alt text](<readme folder/wireframes/Index.png>)

Play Quiz - ![alt text](<readme folder/wireframes/Playquiz.png>)

How to Play - ![alt text](<readme folder/wireframes/How to Play.png>)

Result - ![alt text](<readme folder/wireframes/Result.png>)
...
* CSS is a style language used to describe the presentation of HTML.
* JavaScript is a dynamic functional programming language.
* Font Awesome icon library for social links and globe for website.
* Google Fonts.
* GitHub as software hosting platform that enables users to store their projects in a remote location. This allows for easy access and collaboration on the project from different locations.
